...
import id.kido1611.jadwal.model.NavigationDrawerAdapter;
...
public class FragmentDrawer extends Fragment {
    ...
    public static List<NavDrawerItem> getData() {
        ...
        for (int i = 0; i < titles.length; i++) {
            ...
            if(i==0){
                navItem.setResIcon(R.drawable.ic_list);
            }else if(i==1){
                navItem.setResIcon(R.drawable.ic_settings);
            }else if(i==2){
                navItem.setResIcon(R.drawable.ic_archive);
            }
            data.add(navItem);
